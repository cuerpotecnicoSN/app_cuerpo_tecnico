...
const PitchGraph: React.FC<PitchGraphProps> = ({ onPitchClick, events = [], interactive = true, mode = 'points' }) => {
  ...
  return (
    ...
    >
      ...
      {mode === 'heatmap' ? (
          ...
          return (
            <div 
              ...
              style={{
                ...
                width: '80px',
                height: '80px',
                background: 'radial-gradient(circle, rgba(239, 68, 68, 0.7) 0%, rgba(245, 158, 11, 0.4) 30%, rgba(251, 191, 36, 0.15) 50%, rgba(0,0,0,0) 70%)',
                transform: 'translate(-50%, -50%)',
                pointerEvents: 'none',
        ...
        // Standard points rendering mode
        events.map((ev, idx) => {
          if (!ev.coordinates) return null;
